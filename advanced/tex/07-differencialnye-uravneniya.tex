% !TEX program = xelatex
% Самодостаточный конспект. Компилировать XeLaTeX/LuaLaTeX (tectonic 07-differencialnye-uravneniya.tex).
\documentclass[11pt,a4paper]{article}
\newcommand{\coursename}{Специальные разделы высшей математики}
\newcommand{\rightheader}{§7. Дифференциальные уравнения и теория устойчивости}
\newcommand{\doctitle}{Дифференциальные уравнения и теория устойчивости}

% !TEX program = xelatex
% Самодостаточный конспект. Компилировать XeLaTeX/LuaLaTeX (tectonic 01-evklidovy-prostranstva.tex).
\documentclass[11pt,a4paper]{article}
\newcommand{\coursename}{Специальные разделы высшей математики}
\newcommand{\rightheader}{§1. Евклидовы пространства и ортогональность}
\newcommand{\doctitle}{Евклидовы пространства, нормы, ортогональность}

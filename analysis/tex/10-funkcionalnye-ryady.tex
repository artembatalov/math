% !TEX program = xelatex
% Самодостаточный конспект. Компилировать XeLaTeX/LuaLaTeX (tectonic 10-funkcionalnye-ryady.tex).
\documentclass[11pt,a4paper]{article}
\newcommand{\coursename}{Математический анализ}
\newcommand{\rightheader}{§10. Функциональные последовательности и ряды}
\newcommand{\doctitle}{Функциональные последовательности и ряды}

% !TEX program = xelatex
% Самодостаточный конспект. Компилировать XeLaTeX/LuaLaTeX (tectonic 01-pervoobraznaya-neopr-integral.tex).
\documentclass[11pt,a4paper]{article}
\newcommand{\coursename}{Математический анализ}
\newcommand{\rightheader}{§1. Первообразная и неопределённый интеграл}
\newcommand{\doctitle}{Понятие первообразной и неопределённого интеграла}

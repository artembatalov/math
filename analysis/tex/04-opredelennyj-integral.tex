% !TEX program = xelatex
% Самодостаточный конспект. Компилировать XeLaTeX/LuaLaTeX (tectonic 04-opredelennyj-integral.tex).
\documentclass[11pt,a4paper]{article}
\newcommand{\coursename}{Математический анализ}
\newcommand{\rightheader}{§4. Определённый интеграл Римана}
\newcommand{\doctitle}{Определённый интеграл Римана}
